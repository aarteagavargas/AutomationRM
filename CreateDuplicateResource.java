...
public class CreateDuplicateResource {
  ...
  @Test (priority= 0)
  public void testCreateDuplicatedResource() throws Exception {
    ...
    driver.findElement(By.xpath("(//input[@type='text'])[3]")).sendKeys("Monitor02");
    driver.findElement(By.xpath("(//input[@type='text'])[4]")).clear();
    driver.findElement(By.xpath("(//input[@type='text'])[4]")).sendKeys("Monitor02");
    ...
    driver.findElement(By.xpath("//div/div/button")).click();
    //Wait until the create resource DUPLICATED form appears
    (new WebDriverWait(driver, 60))
    .until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("button.info")));
    ...
    (new WebDriverWait(driver, 60))
    .until(ExpectedConditions.presenceOfElementLocated(By.xpath("//small[2]")));
  ...
  /*FILTER THE RESOURCE*/
    ...
    driver.findElement(By.xpath("//input[@type='text']")).sendKeys("Monitor02");
