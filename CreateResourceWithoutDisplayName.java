...
public class CreateResourceWithoutDisplayName {
  ...
  public void testCreateResourceWithoutDisplayName() throws Exception {
    ...
    driver.findElement(By.xpath("(//input[@type='text'])[3]")).sendKeys("Monitor");
    driver.findElement(By.cssSelector("button.info")).click();
    //Wait until the MESSAGE appears
    (new WebDriverWait(driver, 60))
    .until(ExpectedConditions.presenceOfElementLocated(By.xpath("//small[5]")));
    
    assertEquals("Display name must not be empty", driver.findElement(By.xpath("//small[5]")).getText());
  }
